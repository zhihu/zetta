...
import (
	...
	"github.com/zhihu/zetta/tablestore/rpc/fields"
...
func errTypeMismatch(srcCode, elCode tspb.TypeCode, dst interface{}) error {
	s := srcCode.String()
	if srcCode == tspb.TypeCode_ARRAY {
...
func parseNullTime(v *tspb.Value, p *NullTime, code tspb.TypeCode, isNull bool) error {
	...
	if code != tspb.TypeCode_TIMESTAMP {
		return errTypeMismatch(code, tspb.TypeCode_TYPE_CODE_UNSPECIFIED, p)
	}
	if isNull {
		*p = NullTime{}
		return nil
	}
	x, err := getTimestampValue(v)
	if err != nil {
		return err
	}
...
// decodeNullStringArray decodes tspb.ListValue pb into a NullString slice.
func decodeNullStringArray(pb *tspb.ListValue) ([]NullString, error) {
	if pb == nil {
...
// decodeStringArray decodes tspb.ListValue pb into a string slice.
func decodeStringArray(pb *tspb.ListValue) ([]string, error) {
	if pb == nil {
		return nil, errNilListValue("STRING")
	}
...
// decodeNullInt64Array decodes tspb.ListValue pb into a NullInt64 slice.
func decodeNullInt64Array(pb *tspb.ListValue) ([]NullInt64, error) {
	if pb == nil {
...
// decodeInt64Array decodes tspb.ListValue pb into a int64 slice.
func decodeInt64Array(pb *tspb.ListValue) ([]int64, error) {
	if pb == nil {
		return nil, errNilListValue("INT64")
	}
...
// decodeNullBoolArray decodes tspb.ListValue pb into a NullBool slice.
func decodeNullBoolArray(pb *tspb.ListValue) ([]NullBool, error) {
	if pb == nil {
...
// decodeBoolArray decodes tspb.ListValue pb into a bool slice.
func decodeBoolArray(pb *tspb.ListValue) ([]bool, error) {
	if pb == nil {
		return nil, errNilListValue("BOOL")
	}
...
// decodeNullFloat64Array decodes tspb.ListValue pb into a NullFloat64 slice.
func decodeNullFloat64Array(pb *tspb.ListValue) ([]NullFloat64, error) {
	if pb == nil {
...
// decodeFloat64Array decodes tspb.ListValue pb into a float64 slice.
func decodeFloat64Array(pb *tspb.ListValue) ([]float64, error) {
	if pb == nil {
		return nil, errNilListValue("FLOAT64")
	}
...
// decodeNullTimeArray decodes tspb.ListValue pb into a NullTime slice.
func decodeNullTimeArray(pb *tspb.ListValue) ([]NullTime, error) {
	if pb == nil {
...
// decodeTimeArray decodes tspb.ListValue pb into a time.Time slice.
func decodeTimeArray(pb *tspb.ListValue) ([]time.Time, error) {
	if pb == nil {
		return nil, errNilListValue("TIMESTAMP")
	}
...
// decodeNullDateArray decodes tspb.ListValue pb into a NullDate slice.
func decodeNullDateArray(pb *tspb.ListValue) ([]NullDate, error) {
	if pb == nil {
...
// decodeDateArray decodes tspb.ListValue pb into a civil.Date slice.
func decodeDateArray(pb *tspb.ListValue) ([]civil.Date, error) {
	if pb == nil {
		return nil, errNilListValue("DATE")
	}
...
// the structural information given in tspb.StructType ty.
...
// decodeStruct decodes tspb.ListValue pb into struct referenced by pointer
// ptr, according to
// the structural information given in tspb.StructType ty.
...
// decodeStructArray decodes tspb.ListValue pb into struct slice referenced by
// pointer ptr, according to the
// structural information given in a tspb.StructType.
...
// encodeValue encodes a Go native type into a tspb.Value.
...
func encodeStruct(v interface{}) (*tspb.Value, *tspb.Type, error) {
	typ := reflect.TypeOf(v)
	...
	stf := make([]*tspb.StructType_Field, 0, typ.NumField())
	stv := make([]*tspb.Value, 0, typ.NumField())
...
func encodeStructArray(v interface{}) (*tspb.Value, *tspb.Type, error) {
	...
	values := make([]*tspb.Value, 0, sliceval.Len())
